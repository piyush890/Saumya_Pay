...
public class HomeFragment extends Fragment implements NavClickListenere {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       // Data_card = view.findViewById(R.id.);
...
//        llbillpayment = view.findViewById(R.id.llbillpayment);
        //llbillpayment = view.findViewById(R.id.ll_data);
...
//        });
//
//        Data_card.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View v) {
...
//        paylist.add(pay_option_bean5);
        ...
        CircularBean circularBean1 = new CircularBean();
        circularBean1.setImageID(R.drawable.micro);
        circularBean1.setText("Micro ATM");
